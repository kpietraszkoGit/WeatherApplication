...
public class WeatherManager {
    ...
    public void getWeather(){
        int d = 0;
        String keyAPI= "d3c9f8ba9b96d5b61d961d54d9b5d0ea";
        ...
        try {
            json = readJsonFromUrl("http://api.openweathermap.org/data/2.5/weather?q="+city+"&appid" +
                    "="+keyAPI+"&lang=eng&units=metric"); //wersja po angielsku
        } catch (IOException e) {
            return;
        }
        ...
        json_specific = json.getJSONObject("wind");//z obiektu "wind" pliku json pobieramy "speed"
        this.windSpeed = json_specific.get("speed").toString();
        json_specific = json.getJSONObject("clouds");//z obiektu clouds pobieramy all
